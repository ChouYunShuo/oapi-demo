...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/delete", wrapper.DeleteUser)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/get", wrapper.GetUser)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/post", wrapper.PostUser)
	})
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/put", wrapper.PutUser)
	})
